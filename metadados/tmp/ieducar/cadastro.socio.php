...
// cadastro.socio
$socio = array('idpes_juridica', 'idpes_fisica', 'idpes_rev', 'data_rev', 'origem_gravacao', 'idpes_cad', 'data_cad', 'operacao', 'idsis_rev', 'idsis_cad', );

$socio = array(
'idpes_juridica',     // Tipo: numeric Valor Padrão:  Tamanho: -1
'idpes_fisica',     // Tipo: numeric Valor Padrão:  Tamanho: -1
