...
$fone_pessoa = array('idpes', 'tipo', 'ddd', 'fone', 'idpes_rev', 'data_rev', 'origem_gravacao', 'idpes_cad', 'data_cad', 'operacao', 'idsis_rev', 'idsis_cad', );

$fone_pessoa = array(
'idpes',     // Tipo: numeric Valor Padrão:  Tamanho: -1
'tipo',     // Tipo: numeric Valor Padrão:  Tamanho: -1
'ddd',     // Tipo: numeric Valor Padrão:  Tamanho: -1
'fone',     // Tipo: numeric Valor Padrão:  Tamanho: -1
